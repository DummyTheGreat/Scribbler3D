 ...
 * ├── ...
 */
public partial class DeformingThing : Thing {
    ...
    public override void ProcessImportData() {
        base.ProcessImportData();
        UpdateSkeletonScale();
    }
    ...
    // Receiver
    public override void AttachPart(Thing connector) {
        ...
        if (connector is DeformingThing defCon && defCon.inverseKin.GetSettingCount() > 0) {
